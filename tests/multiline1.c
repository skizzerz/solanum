...
local_private(void)
{
	...
	snprintf(line, sizeof(line), "BATCH +private draft/multiline %s" CRLF, local_chan_p->name);
	client_util_parse(user, line);
	snprintf(line, sizeof(line), "@batch=private PRIVMSG %s :one" CRLF, local_chan_p->name);
	client_util_parse(user, line);
	snprintf(line, sizeof(line), "@batch=private PRIVMSG %s :" CRLF, local_chan_p->name);
	client_util_parse(user, line);
...
local_validation__mixed_commands(void)
{
	...
	snprintf(line, sizeof(line), "BATCH +mixed draft/multiline %s" CRLF, local_chan_p->name);
	client_util_parse(user, line);
	snprintf(line, sizeof(line), "@batch=mixed PRIVMSG %s :first" CRLF, local_chan_p->name);
	client_util_parse(user, line);
	snprintf(line, sizeof(line), "@batch=mixed NOTICE %s :second" CRLF, local_chan_p->name);
	client_util_parse(user, line);
...
local_validation__mismatched_target(void)
{
	...
	snprintf(line, sizeof(line), "BATCH +target draft/multiline %s" CRLF, local_chan_p->name);
	client_util_parse(user, line);
	snprintf(line, sizeof(line), "@batch=target PRIVMSG other :first" CRLF);
	client_util_parse(user, line);
	client_util_parse(user, "BATCH -target" CRLF);
	snprintf(expected, sizeof(expected), ":%s FAIL BATCH MULTILINE_INVALID_TARGET %s other :mismatched target within multiline batch" CRLF, me.name, local_chan_p->name);
	is_client_sendq(expected, user, MSG);
	is_client_sendq_empty(local_chan_p, MSG);
...
local_validation__blank_concat(void)
{
	...
	snprintf(line, sizeof(line), "BATCH +blank draft/multiline %s" CRLF, local_chan_p->name);
	client_util_parse(user, line);
	snprintf(line, sizeof(line), "@batch=blank PRIVMSG %s :first" CRLF, local_chan_p->name);
	client_util_parse(user, line);
	snprintf(line, sizeof(line), "@batch=blank;draft/multiline-concat PRIVMSG %s :" CRLF, local_chan_p->name);
	client_util_parse(user, line);
	client_util_parse(user, "BATCH -blank" CRLF);
	snprintf(expected, sizeof(expected), ":%s FAIL BATCH MULTILINE_INVALID :cannot send blank line with draft/multiline-concat" CRLF, me.name);
	is_client_sendq(expected, user, MSG);
	is_client_sendq_empty(local_chan_p, MSG);
...
local_validation__max_lines(void)
{
	...
	snprintf(expected, sizeof(expected), ":%s FAIL BATCH MULTILINE_MAX_LINES 2 :multiline batch contains too many lines" CRLF, me.name);
	is_client_sendq(expected, user, MSG);
	is_client_sendq_empty(local_chan_p, MSG);
...
local_validation__max_bytes(void)
{
	...
	client_util_parse(user, line);
	snprintf(line, sizeof(line), "@batch=bytes PRIVMSG %s :12345" CRLF, local_chan_p->name);
	client_util_parse(user, line);
	snprintf(line, sizeof(line), "@batch=bytes PRIVMSG %s :67890" CRLF, local_chan_p->name);
	client_util_parse(user, line);
	client_util_parse(user, "BATCH -bytes" CRLF);
	snprintf(expected, sizeof(expected), ":%s FAIL BATCH MULTILINE_MAX_BYTES 10 :multiline batch contains too many bytes" CRLF, me.name);
	is_client_sendq(expected, user, MSG);
	is_client_sendq_empty(local_chan_p, MSG);
